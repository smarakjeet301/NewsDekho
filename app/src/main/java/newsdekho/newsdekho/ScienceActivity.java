...
public class ScienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Function.isNetworkAvailable(getApplicationContext())){
           /* BusinessActivity.DownloadNews newsTask = DownloadNews();
            ...
            ScienceActivity.DownloadNews newsTask= new ScienceActivity.DownloadNews();
            newsTask.execute();
        }else{
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            xml = Function.excuteGet("https://newsapi.org/v2/top-headlines?country=in&category=science"+"&apiKey="+API_KEY, urlParameters);
            return  xml;
        }
        @Override
