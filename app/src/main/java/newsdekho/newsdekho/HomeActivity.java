...
/*
        ...
        username= headerView.findViewById(R.id.navbar_text_username);
        username.setText(user.getDisplayName());
        email = headerView.findViewById(R.id.textView_email);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id==R.id.sign_out){
            ...
            startActivity(new Intent(HomeActivity.this,TechnologyActivity.class));
        }
